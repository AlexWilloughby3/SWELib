...
@[extern "swelib_pq_connect"]
opaque pq_connect : SWELib.Db.ConnectionPool.ConnectionParameters → IO (Option ConnectionHandle)
...
/-- Get the status of a PostgreSQL connection.
    ...
    Issue: https://github.com/SWELib/SWELib/issues/XXX -/
@[extern "swelib_pq_status"]
opaque pq_status : ConnectionHandle → IO SWELib.Db.ConnectionPool.ConnectionStatus
...
/-- Close a PostgreSQL connection.
    ...
    Issue: https://github.com/SWELib/SWELib/issues/XXX -/
@[extern "swelib_pq_close"]
opaque pq_close : ConnectionHandle → IO Unit
...
/-- Reset a PostgreSQL connection.
    ...
    Issue: https://github.com/SWELib/SWELib/issues/XXX -/
@[extern "swelib_pq_reset"]
opaque pq_reset : ConnectionHandle → IO Bool
