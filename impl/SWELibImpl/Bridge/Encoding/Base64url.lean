...
namespace SWELibImpl.Bridge.Encoding
...
axiom base64url_encode_decode : ∀ s data,
    isValidBase64url s → base64urlDecode s = some data → base64urlEncode data = s
...
end SWELibImpl.Bridge.Encoding