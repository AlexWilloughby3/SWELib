...
namespace SWELibImpl.Networking.HttpServer
...
def parseHeaderLine (line : String) : Option Field :=
...
def findHeaderEnd (buf : ByteArray) : Option Nat := do
  let crlfcrlf := "\r\n\r\n".toUTF8
  let mut i := 0
...
end SWELibImpl.Networking.HttpServer
