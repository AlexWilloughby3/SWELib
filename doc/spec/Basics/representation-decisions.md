...
**Implications:**
- Impl bridge axioms must map between FFI method strings and the inductive
...
- Impl bridge axioms must validate that FFI status codes satisfy the range proof
...
**Implications:**
- Impl bridge axioms must convert between FFI byte representations and the `hi`/`lo` pair
